                    ...
                    <div className="grid md:grid-cols-2 gap-8 items-center">
                        ...
                        <div className="space-y-4">
                            <p className="text-gray-600 dark:text-gray-300">
                                ...
                                React. I enjoy building dynamic, scalable applications and am currently diving deeper
                                into
                                the Spring Framework to strengthen my backend expertise.
                            </p>
                            <p className="text-gray-600 dark:text-gray-300">
                                Beyond development, I’m passionate about cybersecurity, blockchain,
                                open-source contribution, and technical writing. I love solving complex problems,
                                optimizing
